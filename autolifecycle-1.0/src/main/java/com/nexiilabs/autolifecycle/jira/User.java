...
public class User  extends AgileResource  {
	...
	@JsonCreator
	public User(RestClient restclient, JSONObject json,@JsonProperty("emailAddress") String emailAddress,@JsonProperty("displayName") String displayName) throws JiraException {
		super(restclient, json);
	...
	@JsonCreator
	public User(RestClient restclient, JSONObject json,@JsonProperty("emailAddress") String emailAddress,
			@JsonProperty("displayName") String displayName,@JsonProperty("active") boolean active,
			@JsonProperty("timeZone") String timeZone) throws JiraException {
		super(restclient, json);
		this.emailAddress = emailAddress;
		this.displayName = displayName;
		this.active = active;
