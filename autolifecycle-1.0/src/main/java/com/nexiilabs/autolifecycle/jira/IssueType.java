...
public class IssueType extends AgileResource {
    ...
    void deserialize(JSONObject json) throws JiraException {
        ...
        this.issueTypeId=Field.getString(json.get("id"));
    }
	...
	public static List<IssueType> getIssueTypes(RestClient restclient) throws JiraException {
		return AgileResource.listOfArrays(restclient, IssueType.class, "/rest/api/2/issuetype","issuetypes");
	}
}
