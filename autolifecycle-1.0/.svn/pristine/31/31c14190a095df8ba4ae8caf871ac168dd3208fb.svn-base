...
public class Epic extends AgileResource {
	...
	public static List<Issue> getIssuesByEpicId(RestClient restclient, long longValue) throws JiraException{

		return AgileResource.list(restclient, Issue.class, RESOURCE_URI + "epic/" + longValue + "/issue", "issues");

	}

public static Epic getEpicsByUserDefinedId(RestClient restclient2, long longValue) throws JiraException{
		
		Epic epic=AgileResource.get(restclient2, Epic.class,  RESOURCE_URI + "board/" + longValue + "/epic");
		return epic;
